const logos = [
  ...
  { id: 3, src: "/certifications/certificacion4.webp", alt: "Logo Carrusel 4", sizeClass: "h-10 w-auto sm:h-10 md:h-14 lg:h-20" },
  { id: 4, src: "/certifications/certificacion5.webp", alt: "Logo Carrusel 5", sizeClass: "h-10 w-auto sm:h-10 md:h-14 lg:h-20" },
  { id: 5, src: "/certifications/certificacion3.webp", alt: "Logo Carrusel 3", sizeClass: "h-16 w-auto sm:h-20 md:h-24 lg:h-32" },
];
