...
const YellowButton = ({ text = "Click me", onClick }) => {
  return (
    <button 
      onClick={onClick}
      className="group flex h-10 items-center gap-2 rounded-full bg-yellow-400 pl-3 pr-4 text-gray-800 shadow-md transition-all duration-300 ease-in-out hover:bg-yellow-500 hover:pl-2 hover:shadow-lg active:bg-yellow-600"
    >
