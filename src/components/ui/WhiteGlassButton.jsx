...
const WhiteGlassButton = ({ text = "Click me", onClick, href = "#" }) => {
  return (
    <a 
      href={href}
      onClick={onClick}
      className="group inline-flex h-10 items-center gap-2 rounded-full bg-white/30 backdrop-blur-md border border-white/30 pl-3 pr-4 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-white hover:pl-2 hover:shadow-lg active:bg-blue-700"
    >
