        ...
        >
          ...
          >
            <div className="flex-1">
              <h2 className="text-xl lg:text-2xl text-gray-800 font-light mb-4 group-hover:text-green-500 transition-colors duration-200">
                {item.question}
              </h2>
            ...
            <motion.button
              ...
              className="bg-green-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-green-600 transition-colors duration-200"
