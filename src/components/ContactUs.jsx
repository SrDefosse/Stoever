      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-7xl mx-auto mt-16 md:mt-24"> {/* Aumentado margen superior */}
          ...
          <div className="w-full h-[350px] md:h-[450px] rounded-xl overflow-hidden shadow-2xl border border-gray-200"> {/* Altura ajustada y borde añadido */}
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3592.688458492478!2d-80.19119492414736!3d25.77103337935751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9b6823bb65e03%3A0x3966a96fbb0d0894!2sMiami%2C%20FL%2033101!5e0!3m2!1sen!2sus!4v1709844144565!5m2!1sen!2sus" // Ejemplo, necesitas tu propio enlace de embed
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
