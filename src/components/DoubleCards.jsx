  ...
  return (
    <section className="relative max-w-7xl mx-auto p-4 min-h-[700px]">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-[#007AFF] text-white p-8 rounded-xl z-10 md:w-1/2 min-h-[500px]">
        ...
        <div className="relative md:w-1/2 min-h-[600px]">
          <div className="bg-gray-300 p-8 h-full shadow-md rounded-xl md:-mt-8 md:-ml-8">
            {/* Aquí solo cambias la ruta de tu imagen */}
            <img
