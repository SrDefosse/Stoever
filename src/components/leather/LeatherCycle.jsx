...
const LeatherCycle = () => {
  ...
  // --- Datos de los Nodos ---
  const nodesData = [
    { id: 'cow', img: '/cow.png', text: 'From Source', angle: -90 },
    { id: 'leather', img: '/leather.png', text: 'To Leather', angle: -18 },
    { id: 'boot', img: '/boot.png', text: 'To Product', angle: 54 },
    { id: 'scissors', img: '/scraps.png', text: 'To Scraps', angle: 126 },
    { id: 'leaf', img: '/nature.png', text: 'To Nature', angle: 198 }
  ];
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen p-4 overflow-hidden relative">
