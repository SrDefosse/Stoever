...
const FooterConstruction = () => {
  ...
  return (
    <footer className="w-full bg-gradient-to-b from-[#1A1A1A] to-[#000000] text-white">
      <div className="w-full px-4 pt-12 pb-12">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:px-8">
            ...
            <ul className="space-y-2">
              ...
              <li className="transition-transform hover:translate-x-1">
                <Link to="/construction/about" className="text-gray-300 hover:text-white flex items-center">
                  <span className="mr-2">›</span>About Us
                </Link>
              </li>
              <li className="transition-transform hover:translate-x-1">
                <Link to="/construction/services" className="text-gray-300 hover:text-white flex items-center">
          ...
          <div className="lg:px-4">
            <h3 className="text-xl font-semibold mb-4 pb-2 border-b border-gray-600">Contact Us</h3>
        ...
        {/* Divisor inferior */}
        <div className="max-w-7xl mx-auto border-t border-gray-600 my-8"></div>
