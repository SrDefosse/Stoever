...
const ConstructionContact = () => {
  ...
  return (
    <section className="w-full relative py-20 md:py-28 bg-[#3A3A3A]">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-white max-w-3xl mx-auto text-base md:text-lg">
            Have questions about our construction projects or services?
            Get in touch with our team and we'll be happy to assist you.
          </p>
        </div>

        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-start shadow-2xl rounded-xl p-8 bg-white">
          
          <div className="flex flex-col h-full pb-4">
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-yellow-700 mb-4">Get in Touch</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-700">Our Location</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-700">Email Us</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-700">Call Us</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-700">Business Hours</h4>
            ...
            <div className="mt-auto pt-8"> 
              <img
                src="/icons/construction_logo.webp"
                alt="Stoever Construction Logo"
                className="h-24 md:h-32 object-contain"
              />
            </div>
          </div>

          <div className="bg-yellow-600/75 backdrop-blur-lg rounded-xl shadow-2xl p-6 md:p-10 border border-white/20">
            {/* Success Message */}
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full group inline-flex h-12 items-center justify-center gap-2 rounded-full bg-yellow-400/30 backdrop-blur-md border border-yellow-400/30 px-6 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-yellow-400 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
        ...
        <div className="max-w-7xl mx-auto mt-16 md:mt-24">
          <h3 className="text-2xl md:text-3xl font-bold text-yellow-700 mb-6 text-center md:text-left">
            Our Headquarters
          </h3>
