    ...
    <section className="py-16 md:py-16 lg:py-20 bg-[#3A3A3A]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center text-gray-300 mb-8 md:mb-12 text-lg">
          <p className="mb-6">
            We are manufacturers and applicators of our extensive range of paints and coatings for construction use. We are committed to providing our clients with the best maintenance, construction, and design services for residential and/or commercial properties.
          </p>
        </div>
