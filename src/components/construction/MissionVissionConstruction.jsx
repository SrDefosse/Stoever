...
const MissionVision = () => {
  ...
  return (
    <div className="w-[70%] mx-auto px-4 py-12">
      {items.map((item, idx) => (
        <motion.div
          key={idx}
        ...
        >
          ...
          >
            <div className="flex-1">
              <h2 className="text-2xl lg:text-4xl text-white font-light mb-4 group-hover:text-yellow-500 transition-colors duration-200">
              ...
              <AnimatePresence>
                {openItems[idx] && (
                  ...
                  >
                    <div className="pl-6 text-white space-y-2 text-base lg:text-lg">
