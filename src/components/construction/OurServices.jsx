      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="md:col-span-2 lg:col-span-1 space-y-12"> {/* Increased spacing between sections */}
          ...
          <div className="space-y-4"> {/* Removed padding-right */}
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4 border-l-4 border-yellow-600 pl-3">Our Services</h2>
            <p className="text-white leading-relaxed">
              We pride ourselves on offering a comprehensive suite of construction services tailored to meet the diverse needs of our clients. Our commitment to quality, innovation, and efficiency ensures that every project, regardless of scale or complexity, is executed to the highest standards.
            </p>
          </div>

          {/* Section 1.2: Vertical Development Details */}
          <div className="space-y-4"> {/* Removed padding-left */}
            <h3 className="text-2xl lg:text-3xl font-semibold text-white mb-4">Vertical Development</h3>
            <p className="text-white leading-relaxed">
              Vertical development refers to the construction of multi-story buildings designed for various purposes, maximizing land use in urban and developing areas. This approach allows for efficient space utilization and caters to the growing demand for residential, commercial, and specialized facilities.
            </p>
