...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Navbar vertical */}
      <motion.nav
        className={`fixed left-0 top-0 h-full bg-white shadow-xl z-40 flex flex-col transition-all duration-300 ${
      ...
      >
        ...
        {/* Social Media Icons */}
        <div className={`p-4 flex justify-center space-x-4 transition-all duration-300 ${
